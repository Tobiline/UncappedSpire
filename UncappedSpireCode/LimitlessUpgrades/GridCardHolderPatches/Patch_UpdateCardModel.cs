...
namespace UncappedSpire.UncappedSpireCode.LimitlessUpgrades.GridCardHolderPatches;

[HarmonyPatch(typeof(NGridCardHolder), "UpdateCardModel")]
public class Patch_UpdateCardModel
{
    [HarmonyTranspiler]
    static IEnumerable<CodeInstruction> Transpiler(IEnumerable<CodeInstruction> instructions)
    {
        ...
        var methodToReplace = AccessTools.Method(typeof(CardModelExtensions), nameof(CardModelExtensions.UpgradeToInternal));
