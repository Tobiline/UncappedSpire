...
//
// namespace UncappedSpire.UncappedSpireCode.AutoMultiSlayer.RoomHandlers;
//
...
// 				var context = new HookPlayerChoiceContext(RunUtil.GetLocalPlayer(), LocalContext.NetId.Value, GameActionType.CombatPlayPhaseOnly);
// 				await CardCmd.AutoPlay(context, cardModel, randomTarget);
...
// 					() => !NCombatRoom.Instance!.Ui.Hand.InCardPlay &&
// 					      NCombatRoom.Instance.Ui.Hand.CurrentMode == NPlayerHand.Mode.Play, ct,
// 					TimeSpan.FromSeconds(10L), "Combat turn could not be ended");
// 				var root = ((SceneTree)Engine.GetMainLoop()).Root;
// 				var endTurnButton = await WaitHelper.ForNode<NEndTurnButton>(root, "/root/Game/RootSceneContainer/Run/RoomContainer/CombatRoom/CombatUi/EndTurnButton", ct, TimeSpan.FromSeconds(5));
// 				await UiHelper.Click(endTurnButton);
// 				await WaitHelper.Until(delegate
// 				{
// 					PlayerCombatState? playerCombatState4 = player.PlayerCombatState;
// 					return playerCombatState4 != null && playerCombatState4.Phase == PlayerTurnPhase.End;
// 				}, ct, TimeSpan.FromSeconds(30L), "Play phase not ended");
// 				
// 				// Original
