...
[HarmonyPatch]
public class Patch_Tempest
{
    static MethodBase TargetMethod()
    {
        var m = AccessTools.Method(typeof(Tempest), "OnPlay");
    ...
    static IEnumerable<CodeInstruction> Transpiler(IEnumerable<CodeInstruction> instructions, MethodBase original)
    {
        ...
        var currentUpgradeLevelField = AccessTools.Field(typeof(Tempest), "_currentUpgradeLevel");
